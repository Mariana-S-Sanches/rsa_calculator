...
import 'package:rsa_calculator/views/rsa.dart';
import 'package:rsa_calculator/widgets/button.dart';
import 'package:rsa_calculator/widgets/alertas.dart';
import 'package:rsa_calculator/widgets/navigator.dart';
import 'package:rsa_calculator/views/tabela_ASCII.dart';
import 'package:rsa_calculator/chaves/key_repository.dart';
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            storedMessage == null ? 'Obtendo mensagem' : '$storedMessage',
                            textScaleFactor: 1,
                          ),
                          trailing: IconButton(
                            onPressed: () {
